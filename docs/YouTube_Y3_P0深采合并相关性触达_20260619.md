...
- 项目数：10
- 项目内去重视频总数：4,532
- `likely_relevant`: 3,783 (83.5%)
- `needs_review`: 447 (9.9%)
- `low_relevance`: 302 (6.7%)

## 4. likely 触达最高的项目（当前为3页下限）

- **春节**: raw=394 / likely=348 (88.3%), low=10 (2.5%); likely_play=753,005,961, raw_play=888,870,351, risk=low, tier=top_20pct_reach
- **太极拳**: raw=817 / likely=768 (94.0%), low=8 (1.0%); likely_play=375,977,929, raw_play=392,928,512, risk=low, tier=top_20pct_reach
- **中国蚕桑丝织技艺**: raw=264 / likely=153 (58.0%), low=22 (8.3%); likely_play=241,296,974, raw_play=328,035,486, risk=low, tier=high_20_40pct_reach
...
- **中国传统制茶技艺及其相关习俗**: raw=175 / likely=130 (74.3%), low=6 (3.4%); likely_play=29,484,123, raw_play=40,454,189, risk=low, tier=middle_40_70pct_reach
- **粤剧**: raw=441 / likely=420 (95.2%), low=14 (3.2%); likely_play=24,638,281, raw_play=35,175,013, risk=medium, tier=middle_40_70pct_reach
- **中国木活字印刷术**: raw=472 / likely=196 (41.5%), low=135 (28.6%); likely_play=66,936,888, raw_play=3,230,525,048, risk=high, tier=lower_70_90pct_reach
...
- **中国木活字印刷术**: raw_tier=top_20pct_reach → likely_tier=lower_70_90pct_reach, delta=-3, low_play_ratio=82.8%

## 7. 3页内自然采空词与跨平台一致低存量

- **中国传统制茶技艺及其相关习俗** — `Chinese tea ceremony`: collected=175, totalResults_estimate≈418024
