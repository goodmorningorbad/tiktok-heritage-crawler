...
输出:
  data/recheck20_<ts>/pages.ndjson   每页一行: keyword/page/cursor_in/items/found/has_more/cursor_ret
  data/recheck20_<ts>/verdicts.ndjson 每词一行: 逐页摘要 + 判定 + 判据
  data/recheck20_<ts>/probe.log
"""
import asyncio
import json
import os
...
SUSPECT_TERMS = [w["keyword"] for w in __import__("json").load(open(str(ROOT / "boundary_recheck20_wordlist.json"), encoding="utf-8"))]
